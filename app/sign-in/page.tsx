...
import { Languages, ArrowLeft, Mail, Lock } from "lucide-react";
  ...
  return (
    <div className="relative flex min-h-screen">
      ...
      <div className="relative hidden w-[45%] overflow-hidden bg-primary lg:block">
        <div className="absolute inset-0 bg-gradient-to-br from-primary via-primary to-[#0d4e49]" />
        <div
        ...
        {/* Floating glyphs */}
        {["Hola", "مرحبا", "你好", "Bonjour", "こんにちは", "안녕"].map(
          (glyph, i) => (
            <motion.span
              key={glyph}
        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-12">
          ...
          <div>
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-white/50">
              Pick up right where you left off. Your personalized learning path
              is waiting for you.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-white/10 bg-white/[0.05] p-5 backdrop-blur-sm">
            <p className="text-sm italic leading-relaxed text-white/60">
              &ldquo;One language sets you in a corridor for life. Two languages
              open every door along the way.&rdquo;
            </p>
      ...
      <div className="relative flex flex-1 items-center justify-center bg-background grain-overlay">
        <div className="absolute inset-0 gradient-mesh-teal opacity-40" />
