...
const vocabulary = [
  ...
  { serbian: "Kofer", english: "Suitcase" },
  { serbian: "Ručni prtljag", english: "Hand luggage" },
  { serbian: "Izlaz", english: "Gate" },
  { serbian: "Let", english: "Flight" },
  { serbian: "Poletanje", english: "Departure" },
  { serbian: "Sletanje", english: "Arrival" },
  { serbian: "Kašnjenje", english: "Delay" },
];

const keySentences = [
  { serbian: "Kada je moj let?", english: "What time is my flight?" },
  { serbian: "Ovo je moj pasoš.", english: "This is my passport." },
  { serbian: "Gde je moja karta?", english: "Where is my ticket?" },
  { serbian: "Želim da predam svoj kofer.", english: "I want to check my suitcase." },
  { serbian: "Da li je let pomeren", english: "Is the flight delayed?" },
  { serbian: "Kada ćemo ući u avion?", english: "When will we board the plane?" },
];

const dialogue = [
  { speaker: "Staff", text: "Dobar dan, pasoš molim.", english: "Hello, your passport please." },
  { speaker: "You", text: "Dobar dan, izvolite.", english: "Hello, here you go." },
  { speaker: "Staff", text: "Imate li kartu?", english: "Do you have your ticket?" },
  { speaker: "You", text: "Da, evo moje karte.", english: "Yes, here is my ticket." },
  { speaker: "Staff", text: "Imate li kofer?", english: "Do you have a suitcase?" },
  { speaker: "You", text: "Da, imam jedan kofer i jedan ručni prtljag.", english: "Yes, I have one suitcase and one hand luggage." },
  { speaker: "Staff", text: "Hvala. Izlaz je broj 12.", english: "Thank you. Gate number 12." },
  { speaker: "You", text: "Hvala. Gde je izlaz?", english: "Thank you. Where is the gate?" },
  { speaker: "Staff", text: "Idite pravo i skrenite desno.", english: "Go straight and turn right." },
  { speaker: "You", text: "U redu, hvala!", english: "Okay, thanks!" },
];
...
const listeningQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Da, imam kofer.", english: "Yes, I have a suitcase." },
      { text: "Idite pravo i skrenite desno.", english: "Go straight and turn right." },
    ],
    correct: 2,
  },
  {
    prompt: "Imate li kofer?",
    ...
    options: [
      ...
      { text: "Nemam kartu.", english: "I don't have a ticket." },
    ],
    correct: 0,
  },
  {
    prompt: "U koliko sati je moj let?",
    promptEnglish: "What time is my flight?",
    options: [
      { text: "Izlaz je broj 12.", english: "Gate number 12." },
      { text: "U tri sata.", english: "At three o'clock." },
...
const quizQuestions = [
  {
    question: "What does 'Aerodrom' mean?",
    options: ["Hotel", "Airport", "Train Station", "Bus Stop"],
    correct: 1,
    serbian: "Aerodrom",
  },
  {
    question: "How do you say 'passport' in Serbian?",
    options: ["Karta", "Kofer", "Pasoš", "Kapija"],
    correct: 2,
    serbian: "Pasoš",
  },
  {
    question: "What does 'Da li let kasni?' mean?",
    options: [
      "Where is my flight?",
    ...
    correct: 1,
    serbian: "Da li let kasni?",
  },
  {
    question: "How do you say 'suitcase' in Serbian?",
    options: ["Ručni prtljag", "Kapija", "Kofer", "Karta"],
    correct: 2,
    serbian: "Kofer",
  },
  {
    question: "What is the correct response to 'Pasoš molim'?",
    options: ["Hvala", "U redu", "Izvolite", "Doviđenja"],
    correct: 2,
    serbian: "Izvolite",
  },
];
...
const QUIZ_ATTEMPTS_KEY = "bllp-serbian-lesson-1-attempts";
const LISTENING_ATTEMPTS_KEY = "bllp-serbian-lesson-1-listening-attempts";
...
const STORAGE_KEY = "bllp-serbian-lesson-1";
...
const aiPrompts = [
  {
    ai: "Dobar dan. Kuda putujete?",
    aiEnglish: "Hello. Where are you flying to?",
    expected: "Putujem za Beograd.",
    expectedEnglish: "I am flying to Belgrade.",
  },
  {
    ai: "Pasoš molim.",
    aiEnglish: "Your passport please.",
    expected: "Izvolite, evo mog pasoša.",
    expectedEnglish: "Here you go, here is my passport.",
  },
  {
    ai: "Koliko kilograma ima vaš kofer?",
    aiEnglish: "How many kilograms is your suitcase?",
    expected: "Dvadeset kilograma.",
    expectedEnglish: "Twenty kilograms.",
  },
];
