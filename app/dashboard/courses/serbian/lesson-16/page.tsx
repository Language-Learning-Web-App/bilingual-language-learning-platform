...
const vocabulary = [
    { serbian: "А а", english: "A a" },
    { serbian: "Б б", english: "B b" },
    { serbian: "В в", english: "V v" },
    { serbian: "Г г", english: "G g" },
    { serbian: "Д д", english: "D d" },
    { serbian: "Ђ ђ", english: "Đ đ" },
    { serbian: "Е е", english: "E e" },
    { serbian: "Ж ж", english: "ž ž" },
    { serbian: "З з", english: "Z z" },
    { serbian: "И и", english: "I i" },
    { serbian: "Ј ј", english: "J j" },
    { serbian: "К к", english: "K k" },
    { serbian: "Л л", english: "L l" },
    { serbian: "Љ љ", english: "Lj lj" },
    { serbian: "М м", english: "M m" },
    { serbian: "Н н", english: "N n" },
    { serbian: "Њ њ", english: "Nj nj" },
    { serbian: "О о", english: "O o" },
    { serbian: "П п", english: "P p" },
    { serbian: "P р", english: "R r" },
    { serbian: "С с", english: "S s" },
    { serbian: "Т т", english: "T t" },
    { serbian: "Ћ ћ", english: "Ć ć" },
    { serbian: "У у", english: "U u" },
    { serbian: "Ф ф", english: "F f" },
    { serbian: "Х х", english: "H h" },
    { serbian: "Ц ц", english: "C c" },
    { serbian: "Ч ч", english: "Č č" },
    { serbian: "Џ џ", english: "Dž dž" },
    { serbian: "Ш ш", english: "Š š" },
    
];

const keySentences = [
    { serbian: "вода", english: "water/voda" },
    { serbian: "млеко", english: "milk/mleko" },
    { serbian: "јабука", english: "apple/jabuka" },
    { serbian: "авион", english: "airplain/avion" },
    { serbian: "продавница", english: "grocery store/prodavnica" },
    { serbian: "рачун", english: "receipt/racun" },
...
const QUIZ_ATTEMPTS_KEY = "bllp-serbian-lesson-16-attempts";
const LISTENING_ATTEMPTS_KEY = "bllp-serbian-lesson-16-listening-attempts";
...
const STORAGE_KEY = "bllp-serbian-lesson-16";
...
export default function SerbianLesson16Page() {
                ...
                {started && currentSection === 3 && (
                    ...
                    >
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h2 className="text-lg font-semibold">Guess the Letter</h2>
                        </div>
